...
global_function_table.insert({"BW": "Thyroid.get_local_vals()[\'Organ_Weight\'] + Pancreas.get_local_vals()[\'Organ_Weight\'] + Spleen.get_local_vals()[\'Organ_Weight\'] + Kidneys.get_local_vals()[\'Organ_Weight\'] + Diaphragm.get_local_vals()[\'Organ_Weight\'] + Brain.get_local_vals()[\'Organ_Weight\'] + Liver.get_local_vals()[\'Organ_Weight\'] + Gut.get_local_vals()[\'Organ_Weight\'] + Blood.get_local_vals()[\'Organ_Weight\'] + Bones.get_local_vals()[\'Organ_Weight\'] + Skin.get_local_vals()[\'Organ_Weight\'] + Adipose_tissue.get_local_vals()[\'Organ_Weight\'] + Skeletal_muscle.get_local_vals()[\'Organ_Weight\'] + Heart.get_local_vals()[\'Organ_Weight\'] "})
global_function_table.insert({"sVCO2": "VCO2 / BW"})
global_function_table.insert({"sVO2": "VO2 / BW"})

organ_db.purge_table("SystemicOrgans")
systemic_organ_table = organ_db.table("SystemicOrgans")
systemic_organ_table.insert({"name": "Skeletal_muscle", "functions": {"VO2": f_VO2, "VCO2": f_VCO2, "SMRCO2": f_SMRCO2, "Venous_Glucose": f_ven_glu, "Venous_O2": f_ven_O2, "Venous_CO2": f_ven_CO2, "Venous_Lac": f_ven_lac},
...
systemic_organ_table.insert({"name": "Adipose_tissue", "functions": {"VO2": f_VO2, "VCO2": f_VCO2, "SMRCO2": f_SMRCO2, "Venous_Glucose": f_ven_glu, "Venous_O2": f_ven_O2, "Venous_CO2": f_ven_CO2, "Venous_Lac": f_ven_lac},
                             "variables": {"BF": [0, 0.6, 0.2], "SMRO2": [0, 0.5, 0.07], "Organ_Weight" : [5, 100, 18], "VO2": [5, 20, 12.6], "RQ": [0, 1, 1], "SMRglu": [0, 0, 0], "SMRglu_prod": [0, 0, 0]}})
systemic_organ_table.insert({"name": "Skin", "functions": {"VO2": f_VO2, "SMRCO2": f_SMRCO2, "Venous_Glucose": f_ven_glu, "Venous_O2": f_ven_O2, "Venous_CO2": f_ven_CO2, "Venous_Lac": f_ven_lac},
...
systemic_organ_table.insert({"name": "Bones", "functions": {"VO2": f_VO2, "Venous_Glucose": f_ven_glu, "Venous_O2": f_ven_O2, "Venous_Lac": f_ven_lac},
                             "variables": {"BF": [0, 1, 0.1], "SMRO2": [0, 0.4, 0.02], "Organ_Weight" : [5, 12, 8], "VO2": [0.4, 13, 1.6], "SMRglu": [0, 0, 0], "SMRglu_prod": [0, 0, 0]}})
systemic_organ_table.insert({"name": "Blood", "functions": {"VO2": f_VO2, "Venous_Glucose": f_ven_glu, "Venous_O2": f_ven_O2, "Venous_Lac": f_ven_lac},
...
systemic_organ_table.insert({"name": "Liver", "functions": {"VO2": f_VO2, "VCO2": f_VCO2, "SMRCO2": f_SMRCO2, "Venous_Glucose": f_ven_glu, "Venous_O2": f_ven_O2, "Venous_CO2": f_ven_CO2, "Venous_Lac": f_ven_lac},
...
systemic_organ_table.insert({"name": "Brain", "functions": {"VO2": f_VO2, "VCO2": f_VCO2, "SMRCO2": f_SMRCO2, "Venous_Glucose": f_ven_glu, "Venous_O2": f_ven_O2, "Venous_CO2": f_ven_CO2, "Venous_Lac": f_ven_lac},
...
systemic_organ_table.insert({"name": "Heart", "functions": {"VO2": f_VO2, "VCO2": f_VCO2, "SMRCO2": f_SMRCO2, "Venous_Glucose": f_ven_glu, "Venous_O2": f_ven_O2, "Venous_CO2": f_ven_CO2, "Venous_Lac": f_ven_lac},
...
systemic_organ_table.insert({"name": "Diaphragm", "functions": {"VO2": f_VO2, "SMRCO2": f_SMRCO2, "Venous_O2": f_ven_O2, "Venous_CO2": f_ven_CO2, "Venous_Lac": f_ven_lac},
                             "variables" : {"BF": [0, 0.02, 0.01], "SMRO2": [0, 10, 1], "Organ_Weight" : [0.2, 0.5, 0.31], "VO2": [1, 10, 3], "SMRglu": [0, 0, 0], "SMRglu_prod": [0, 0, 0], "RQ": [0, 1, 1]}})
systemic_organ_table.insert({"name": "Kidneys", "functions": {"VO2": f_VO2, "VCO2": f_VCO2, "SMRCO2": f_SMRCO2, "Venous_Glucose": f_ven_glu, "Venous_O2": f_ven_O2, "Venous_CO2": f_ven_CO2, "Venous_Lac": f_ven_lac},
